...
class App(customtkinter.CTk):
    ...
    def btn_convertir_c_f_on_click(self):
        ...
        temperatura_centigrados = int(temperatura_centigrados)

        ecuacion_a = temperatura_centigrados  * 9 / 5
        
        ecuacion_b = ecuacion_a + 32

        message=f"la temperatura en fahrenheit es :{ecuacion_b}"
        alert("temperatura",message)

    def btn_convertir_f_c_on_click(self):
        temperatura_fahrenheit = self.txt_temperatura_f.get()
        temperatura_fahrenheit = int(temperatura_fahrenheit)
        
        ecuacion_c = temperatura_fahrenheit - 32
        
        ecuacion_d = ecuacion_c * 5 / 9
    
        message="La temperatura en centigrados es :",ecuacion_d
        alert("La temperatura",message)
