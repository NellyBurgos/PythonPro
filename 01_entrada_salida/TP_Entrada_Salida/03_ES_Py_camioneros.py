...
3.	Para el departamento de logística:
	...
	A.	Es necesario saber la cantidad camiones que harian falta para transportar los materiales que se utilizarán para la construcción de un edificio. Para ello, se ingresa la cantidad de toneladas necesarias de materiales a transportar. 
...
class App(customtkinter.CTk):
    ...
    def btn_cantidad_camiones_on_click(self):
        ...
        alert("Cantidad de camiones",f"La cantidad de camiones que se necesita para trasportar 3500 kg es de {camiones} camiones")
    ...
    def btn_tiempo_llegada_on_click(self):
        ...
        horas = kilometros // 90
        minutos_segundos = kilometros % 90
        minutos_segundos = minutos_segundos / 90
        minutos_segundos = minutos_segundos * 60

        minutos= round(minutos_segundos)
              
        alert("Tiempo necesario",f"El recorrido tardo : {horas} horas: {minutos} minutos" )
