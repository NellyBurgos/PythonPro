...
---
Enunciado:
Al presionar el botón 'Mostrar', se deberá obtener el contenido de la caja de texto txtEdad, 
...
class App(customtkinter.CTk):
    ...
    def btn_mostrar_on_click(self):
        ...
        if ingreso_edad <=12 or ingreso_edad>=20:
            informe = "No es adolecente"
        else:
             informe = "Si es adolecente"   
