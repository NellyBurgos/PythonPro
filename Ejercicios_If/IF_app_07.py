...
class App(customtkinter.CTk):
    ...
    def btn_mostrar_on_click(self):
        ...
        if  edad_numero >= 16 and nacionalidad == "NATIVO":
            alert (" Atencion:","Apto para votar")

        elif edad_numero >= 18 and nacionalidad == "NATURALIZADO":   
             alert("Atencion","Apto para voto") 

        else:
            alert("Atencion "," No esta Apto para votar")
