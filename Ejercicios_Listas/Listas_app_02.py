...
class App(customtkinter.CTk):
    ...
    def btn_calcular_on_click(self):
        ...
        sumatoria = sum(lista_datos)  # Calcula la sumatoria de los números en la lista
        promedio = sumatoria //len(lista_datos)  # Calcula el promedio de los números en la lista
    
        alert("Resultados", f"La sumatoria de los números es: {sumatoria}\nEl promedio de los números es: {promedio}")
